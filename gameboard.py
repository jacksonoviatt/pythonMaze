class GameBoard:
    ...
    # using this function to check the players position and returns true if the players position is a winner
    
    # this function will check the players position when called in app.py 
